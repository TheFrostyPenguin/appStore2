...
const resolvedUrl = window.SUPABASE_URL || window.env?.SUPABASE_URL || localStorage.getItem('https://lleehmgwruvxcfkjnfvn.supabase.co');
const resolvedKey = window.SUPABASE_ANON_KEY || window.env?.SUPABASE_ANON_KEY || localStorage.getItem('eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxsZWVobWd3cnV2eGNma2puZnZuIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjQyNTE3NzgsImV4cCI6MjA3OTgyNzc3OH0.-R-r5IPyE_lW_YS0gGlW5TEq6x1pAgsh560FxnGttNU');
