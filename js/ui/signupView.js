      ...
      <div class="w-full max-w-md space-y-8">
        <div class="flex flex-col items-center text-center space-y-2">
          <div class="inline-flex items-center gap-3 rounded-full bg-slate-900/70 border border-slate-800 px-4 py-2 shadow-lg">
            ...
            <span class="text-sm font-semibold text-slate-200">GE's App Store</span>
          </div>
          <div class="space-y-2">
            <h1 class="text-3xl sm:text-4xl font-semibold tracking-tight text-white">Create an account</h1>
            <p class="text-sm text-slate-400">Get started with GE's App Store.</p>
          </div>
        </div>
        ...
        <p class="text-center text-xs text-slate-500">© 2024 GE's App Store. All rights reserved.</p>
      </div>
    </div>
  `;
